...
SWEP.PrintName						= "Jasper's GALAAR-15 Auto Blaster Rifle"
...
[2] = {atts = {"training_mod","explosive_mod","stealth_mod"},order = 2},
}
...
SWEP.VElements = {
    ["dc15a"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_supercommando.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(.4, -9.5, 1.5), angle = Angle(0, -90, 0), size = Vector(.9, .9, .9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 2, bodygroup = {} },

}

SWEP.WElements = {
    ["dc15a"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_supercommando.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6, 1.9, -1), angle = Angle(-10, 0, 180), size = Vector(.9, .9, .9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 2, bodygroup = {} }
}
