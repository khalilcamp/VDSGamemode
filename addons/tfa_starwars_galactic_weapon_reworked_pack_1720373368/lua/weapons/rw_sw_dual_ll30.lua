...
SWEP.Primary.RPM					= 205*2*0.8
SWEP.Primary.RPM_Burst				= 205*2*0.8
...
SWEP.Primary.Sound 					= Sound ("w/ll30.wav");
...
SWEP.VElements = {
	["rk3"] = { type = "Model", model = "models/weapons/ll30.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(4, -1, -0.5), angle = Angle(80, -2, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/weapons/ll30.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-4, 1, 0.5), angle = Angle(95, 178, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["rk3"] = { type = "Model", model = "models/weapons/ll30.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(03, 01, -0.75), angle = Angle(0, 80, 2), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/weapons/ll30.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(03, 01, 0.75), angle = Angle(0, -100, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
