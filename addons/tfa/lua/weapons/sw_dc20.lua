...
SWEP.PrintName						= "DC-20"
SWEP.Type							= "Republic Black Ops Carbine"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.Sound 					= Sound ("everfall/weapons/f-11aba/fire/blasters_f-11aba_heavycannon_laser_close_var_01.mp3");
SWEP.Primary.ReloadSound 			= Sound ("w/rifles.wav");
SWEP.Primary.PenetrationMultiplier 	= 0
SWEP.Primary.Damage					= 30*3
...
SWEP.VElements = {
	["dc19"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/btx50_oppressor.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-.1, -8, 0), angle = Angle(01, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
SWEP.WElements = {
	["dc19"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/btx50_oppressor.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-8, 2.3, 1), angle = Angle(-13, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
