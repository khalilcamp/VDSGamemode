...
ITEM.name = "Carne"
ITEM.description = "Um pedaço de carne animal, bem suculenta e pronta para consumo."
ITEM.price = 45
ITEM.category = "Bebidas e Comidas"

-- Item Configuration

ITEM.model = "models/food/steak.mdl"
ITEM.skin = 1
...
ITEM.functions.Apply = {
    ...
    OnRun = function(itemTable)
        ...
        ix.chat.Send(ply, "me", "comeria a carne bem preparada com cheiro bom.", false)
        ply:Freeze(true)
