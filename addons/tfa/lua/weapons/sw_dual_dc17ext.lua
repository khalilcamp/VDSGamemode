...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc17_ext.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(-9.5, 2, 0), angle = Angle(0, 0, 78), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["dc17+"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc17_ext.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(9.5, -2, 3), angle = Angle(180, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc17_ext.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(-8, 0, 1.5), angle = Angle(0, 0, 0), size = Vector(.89, .89, .89), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["dc17+"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc17_ext.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-8, 0, -1.5), angle = Angle(0, -10 ,180), size = Vector(.89, .89, .89), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
