...
function EFFECT:Init( data )
	...
	for i = 0,30 do
		...
		if particle then
			...
			particle:SetStartAlpha( 1000 )
			particle:SetStartSize( math.Rand(1300,1600) )
			particle:SetEndSize( math.Rand(1100,1150) )
	...
	for i = 0, 20 do
		...
		if particle then
			...
			particle:SetStartSize( math.Rand(1240,1480) )
	...
	for i = 0, 40 do
		...
		if particle then
			...
			particle:SetEndSize( math.Rand(1200,1400) )
