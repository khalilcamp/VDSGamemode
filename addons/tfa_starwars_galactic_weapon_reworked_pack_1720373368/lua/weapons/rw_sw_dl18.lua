...
SWEP.Primary.Sound 					= Sound ("w/dl18.wav");
...
SWEP.VMPos = Vector(2.04, -8, -00.93)
...
--SWEP.IronSightsPos = Vector(-6, -6, 3.1)
SWEP.IronSightsPos = Vector(-6.175, -6, 1.45)
...
SWEP.VElements = { --
	--["d"] = { type = "Model", model = "models/swbf3/outerrim/weapons/dl18.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(0, -3.9, -3.1), angle = Angle(0, 90, 0), size = Vector(1.05, 1.05, 1.05), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["d"] = { type = "Model", model = "models/hauptmann/star wars/weapons/dl18.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(0.2, -3.5, -3.75), angle = Angle(0, 90, 0), size = Vector(1.05, 1.05, 1.05), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	--["d"] = { type = "Model", model = "models/swbf3/outerrim/weapons/dl18.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7, 02, 01), angle = Angle(-1, -7, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	["d"] = { type = "Model", model = "models/hauptmann/star wars/weapons/dl18.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7, 02, 02), angle = Angle(-5, -7, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
