...
SWEP.Primary.Sound 					= Sound ("everfall/weapons/t-21/style_1/blasters_t21_laser_close_var_05.mp3");
...
SWEP.IronSightsPos = Vector(-3.8, -6, 04.15)
...
SWEP.VElements = {
	["t21"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/t19.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(1.7, -9, 1.5), angle = Angle(0, -90, 0), size = Vector(.9, .9, .9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}	

SWEP.WElements = {
	["t21"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/t19.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-5, 1.8, 1), angle = Angle(-16, 0, 175), size = Vector(.9, .9, .9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
