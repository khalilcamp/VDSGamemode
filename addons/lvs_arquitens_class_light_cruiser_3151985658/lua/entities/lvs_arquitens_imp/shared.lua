...
ENT.PrintName = "Arquitens-Class Light Cruiser (Imperial)"
ENT.Author = "Dec"
ENT.Information = "Arquitens-Class Light Cruiser (Imperial)"
ENT.Category = "[LVS] SW-Vehicles"

ENT.Spawnable			= true
ENT.AdminSpawnable		= false

ENT.MDL = "models/DiggerThings/Arquitens/imperial.mdl"
ENT.GibModels = {
