...
SWEP.PrintName						= "X-42.2 Heavy Microthrower"
SWEP.Type							= "Heavy Microthrower"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/btx42_pistol.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(.2, -14, 0), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["e5"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/btx42_pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-9, 1.9, 1.2), angle = Angle(-11, 0, 180), size = Vector(.9, .9, .9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
