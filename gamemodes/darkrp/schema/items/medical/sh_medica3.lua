...
ITEM.name = "Tubo de Kolto"
ITEM.description = "Um simples tubo de kolto, usado para fins medicinais também, embora que seja mais fraco ainda é útil, com a capacidade de +25 de Vitalidade."
ITEM.price = 45
