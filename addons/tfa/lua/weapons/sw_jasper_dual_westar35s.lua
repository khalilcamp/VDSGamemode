...
SWEP.PrintName						= "Jaspers Dual Westar 35's"
SWEP.Type							= "Mandalorian Dual Blaster Pistols"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.ClipSize				= 22*2
SWEP.Primary.DefaultClip			= 22*8
...
SWEP.VElements = {
	["rk3"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_pistol.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(-6.5, 1.4, 0), angle = Angle(0, 0, 80), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 2, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_pistol.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(7, -2, 2.6), angle = Angle(0, 180, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 2, bodygroup = {} }
}

SWEP.WElements = {
	["rk3"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_pistol.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(-7.2, -2, 1.7), angle = Angle(0, -10, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 2, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-7.2, .9, -1.7), angle = Angle(180, 170, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 2, bodygroup = {} }
}
