...
force.StartUse = function( ply )
	...
	if need > 0 and available >= 5 then
		...
		ply:lscsTakeForce()
		ply:SetHealth( math.min(ply:Health() + 50  ) )
...
local force = {}
force.PrintName = "Poder Ilimitado"
force.Author = "Blu-x92 / Luna"
force.Description = "GLORIA AO SENADO GALATICO"
force.id = "lightning"
force.OnClk =  function( ply, TIME )
