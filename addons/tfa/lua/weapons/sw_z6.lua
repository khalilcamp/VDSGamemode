...
SWEP.VElements = {
	["z6"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/z6.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(-2, -5, -6.5), angle = Angle(0, -90, 0), size = Vector(1.2, 1.1, 1.2), color = Color(180, 180, 180, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}	

SWEP.WElements = {
	["z6"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/z6.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6.2, 2, 2), angle = Angle(-6, 0, 180), size = Vector(1, 1, 1), color = Color(180, 180, 180, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
