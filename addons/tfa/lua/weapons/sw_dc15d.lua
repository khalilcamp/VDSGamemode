...
SWEP.PrintName						= "DC-15D"
SWEP.Type							= "Advanced Recon Commando Heavy Blaster Rifle"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.Sound 					= Sound ("everfall/weapons/f-11d/blasters_f-11d_laser_close_var_04.mp3");
...
SWEP.IronSightsPos = Vector(-4.55, -1, 4.5)
...
SWEP.VElements = {
	["dc15a"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc15d.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(1, -8, 2), angle = Angle(0, -90, 0), size = Vector(.8, .8, .8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}	

SWEP.WElements = {
	["dc15a"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc15d.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6, 2.5, .5), angle = Angle(-13, 0, 180), size = Vector(.9, .9, .9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
