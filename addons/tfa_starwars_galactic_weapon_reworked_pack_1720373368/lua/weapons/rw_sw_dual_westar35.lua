...
SWEP.Primary.Sound 					= Sound ("w/westar35.wav");
...
SWEP.VElements = {
	["rk3"] = { type = "Model", model = "models/sw_battlefront/weapons/westar_35_pistol.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(4, 2, -1), angle = Angle(80, -2, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/sw_battlefront/weapons/westar_35_pistol.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-4, -2, 1), angle = Angle(95, 178, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["rk3"] = { type = "Model", model = "models/sw_battlefront/weapons/westar_35_pistol.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(04.2, 01.5, 1.5), angle = Angle(0, 80, 2), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/sw_battlefront/weapons/westar_35_pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(04.2, 01.5, -1.25), angle = Angle(0, -100, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
