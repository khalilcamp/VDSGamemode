...
SWEP.Type							= "Republic Stun Blaster Pistol"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.IronSightsPos = Vector(-5.4, -6, 2.6)
...
SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc17.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-9, 1.2, -1.5), angle = Angle(0, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
