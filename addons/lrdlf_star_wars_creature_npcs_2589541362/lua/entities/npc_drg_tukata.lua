...
if SERVER then
  ...
  function ENT:OnMeleeAttack(enemy)
    ...
    self:PlaySequenceAndMove("default_attack", 2, self.FaceEnemy)
      self:Attack({
        damage = 50,
        type = DMG_SLASH,
