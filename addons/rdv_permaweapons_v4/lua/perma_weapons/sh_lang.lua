...
function NCS_PERMAWEAPONS.AddLang(lang, note)
    RegisterLang(lang)
...
function NCS_PERMAWEAPONS.GetLang(lang, note, replacements)
    if !lang then
        lang = NCS_PERMAWEAPONS.CFG.LANG or "en"
    end
...
function NCS_PERMAWEAPONS.GetLanguages()
    return LANG
end