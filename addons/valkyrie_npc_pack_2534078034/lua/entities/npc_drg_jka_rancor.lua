...
-- Misc --
ENT.PrintName = "[JK:JA] Dathomir Rancor"
ENT.Category = "[Valkyrie] Creature NPCs"
ENT.Models = {"models/jediacad/rancor.mdl"}
ENT.Skins = {0}
ENT.ModelScale = 1
ENT.CollisionBounds = Vector(100, 90, 90)
...
ENT.ClimbSpeed = 60
ENT.ClimbUpAnimation = ACT_IDLE
ENT.ClimbDownAnimation = ACT_IDLE
ENT.ClimbAnimRate = 1
