...
SWEP.Primary.Sound 					= Sound ("everfall/weapons/dlt-19/blasters_dlt19_laser_close_var_06.mp3");
...
SWEP.VElements = {
	["dlt19"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dlt16.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(1.75, -9.5, 1), angle = Angle(0, -90, 0), size = Vector(.9, .9, .9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}	

SWEP.WElements = {
	["dlt19"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dlt16.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-8, 1.75, 1), angle = Angle(-16, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
