...
SWEP.IronSightsPos = Vector(-5.2, -4, 2.75)
...
SWEP.VElements = {
	["dp23"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dp23.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(2, -11, 0), angle = Angle(0, -93, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0, [2] = 1, [3] = 1} }
}	

SWEP.WElements = {
	["dp23"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dp23.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-7.7, 2.2, 0), angle = Angle(-12, 0, 172), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0, [2] = 1, [3] = 1} }
}
