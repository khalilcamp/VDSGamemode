...
function NCS_LOADOUTS.AddLang(lang, note)
    RegisterLang(lang)
...
function NCS_LOADOUTS.GetLang(lang, note, replacements)
    if !lang then
        lang = NCS_LOADOUTS.CONFIG.LANG or "en"
    end
...
function NCS_LOADOUTS.GetLanguages()
    return LANG
end