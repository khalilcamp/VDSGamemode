...
SWEP.IronSightsPos = Vector(-6, -5.5, 01.5)
...
SWEP.VElements = {
	["iqa11"] = { type = "Model", model = "models/sw_battlefront/weapons/iqa11_rifle.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0.5, 2.5, 0.5), angle = Angle(0, -90, 0), size = Vector(1.25, 1.25, 1.25), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0, [2] = 0, [3] = 1} },
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0.5, 2.8, 6.05), angle = Angle(0, 90, 0), size = Vector(0.259, 0.259, 0.259), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
}	

SWEP.WElements = {
	["iqa11"] = { type = "Model", model = "models/sw_battlefront/weapons/iqa11_rifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.5, 0, -0.5), angle = Angle(-12, 0, 170), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0, [2] = 0, [3] = 1} }
}
