--SWEP.NZPaPName = "F1W Nitrogen Cooled"
SWEP.Base				= "tfa_gun_base"
SWEP.Category				= "TFA DOI" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "Flammenwerfer 41"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Range = 20 * 30 --Flame Distance
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_doi/v_flammenwerfer41.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_doi/w_flammenwerfer41.mdl" -- Weapon world model path
SWEP.Bodygroups_W = nil --{
--[0] = 1,
--[1] = 4,
--[2] = etc.
--}
SWEP.DefaultHoldType = "shotgun" -- This is how others view you carrying the weapon. Options include:
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0.201, 0, 1.759) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(-16.3, 27.799, -22.3) --Change this, using SWEP Creation Kit preferably
--[[IRONSIGHTS]]--
SWEP.data = {}
...
--[[INSPECTION]]--
SWEP.InspectPos = Vector(6.679, 0, 1.279)--Vector(0,0,0) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(16.899, 37, 15.199)--Vector(0,0,0) --Replace with a vector, in style of ironsights angle, to be used for inspection
