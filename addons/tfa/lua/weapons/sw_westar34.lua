...
SWEP.PrintName						= "Westar-34 Sidearm"
...
SWEP.IronSightsPos = Vector(-6.575, -4, 1.1)
...
SWEP.VElements = { --
	["d"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dr20.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-1, 11, 0), angle = Angle(0, 90, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["d"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dr20.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.5, 02, -01.2), angle = Angle(-5, -7, 180), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
