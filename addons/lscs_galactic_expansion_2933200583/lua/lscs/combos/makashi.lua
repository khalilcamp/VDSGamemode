COMBO.id = "makashi"
COMBO.PrintName = "Makashi"
COMBO.Author = "Kong"
COMBO.Description = "First developed when lightsabers started becoming more common among both the Jedi and the Sith, Makashi, or Form II, is a graceful form suited to skilled duelists."
