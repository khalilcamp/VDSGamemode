...
SWEP.PrintName						= "DC-17 Shielded (CG)"
SWEP.Type							= "Republic Coruscant Guard Weaponized Shield"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc17.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-1.2, 12, 0.2), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc17.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-10, 1.2, -1.5), angle = Angle(0, -07, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
function SWEP:SetupShield()
	...
	self.shieldProp:SetModel("models/cs574/weapons/shields/shield2.mdl");
	...
	if attach == nil or attach == 0 then
		...
		attach = self.Owner:LookupAttachment("righthand");
		nothand = true;
		if attach == nil or attach == 0 then
