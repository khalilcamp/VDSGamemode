...
ATTACHMENT.ShortName = "S30s" --Abbreviation, 5 chars or less please
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { 
	TFA.AttachmentColors["="],"Congela o alvo por 30 segundos",
	TFA.AttachmentColors["-"],"Sem dano",
}
ATTACHMENT.Icon = "entities/atts/stun30.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
