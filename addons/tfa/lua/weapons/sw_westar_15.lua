...
SWEP.PrintName						= "GALAAR-15 Marksman Blaster"
SWEP.Type							= "Mandalorian Marksman Blaster"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.IronSightsPos = Vector(-5.25, -5.9, 2.7)
...
SWEP.VElements = {
	["iqa11"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_sniper.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(1.4, -8.8, 1), angle = Angle(0, -90, 0), size = Vector(.9, .9, .9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0, [2] = 0, [3] = 1} },
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector( .23, 3, 4.89), angle = Angle(0, 90, 0), size = Vector(0.259, 0.259, 0.259), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
}	

SWEP.WElements = {
	["iqa11"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_sniper.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-9, 2.7, 1.5), angle = Angle(-11, 0, 170), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0, [2] = 0, [3] = 1} }
}
