...
SWEP.Type							= "Advanced Recon Commando Blaster Pistol"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.IronSightsPos = Vector(-5.4, -6, 2.5)
...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc17_ext.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-1.8, 12.6, .5), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc17_ext.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-8, 3, -.6), angle = Angle(-5, 0, 180), size = Vector(.89, .89, .89), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
