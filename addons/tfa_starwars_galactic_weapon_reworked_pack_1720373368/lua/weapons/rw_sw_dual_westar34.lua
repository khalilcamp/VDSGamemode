...
SWEP.Primary.RPM					= 210*2*0.8
SWEP.Primary.RPM_Burst				= 210*2*0.8
...
SWEP.VElements = {
	["rk3"] = { type = "Model", model = "models/cs574/weapons/westar34.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(6, 1, -1.5), angle = Angle(-05, -2, 90), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/cs574/weapons/westar34.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-6, -1, 1.5), angle = Angle(0, 178, 90), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["rk3"] = { type = "Model", model = "models/cs574/weapons/westar34.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(7.75, 01.75, 0.5), angle = Angle(0, -10, 2), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/cs574/weapons/westar34.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.75, 01.75, -0.5), angle = Angle(0, -10, 180), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
