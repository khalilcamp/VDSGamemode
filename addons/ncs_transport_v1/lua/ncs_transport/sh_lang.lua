...
function NCS_TRANSPORT.AddLang(lang, note)
    RegisterLang(lang)
...
function NCS_TRANSPORT.GetLang(lang, note, replacements)
    if !lang then
        lang = NCS_TRANSPORT.CONFIG.LANG or "en"
    end
...
function NCS_TRANSPORT.GetLanguages()
    return LANG
end