...
SWEP.VElements = {
	...
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "", rel = "m57_scope", pos = Vector(-06.875, -0.025, 8.5), angle = Angle(0, 180, 0), size = Vector(0.29, 0.29, 0.29), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
