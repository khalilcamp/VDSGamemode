...
-- Misc --
ENT.PrintName = "Shyrack"
ENT.Category = "[Atlantis] Creature NPCs"
ENT.Models = {"models/swtor/npcs/dragonbat_shyrack.mdl"}
ENT.Skins = {0}
ENT.ModelScale = 1
ENT.BloodColor = BLOOD_COLOR_RED
--ENT.CollisionBounds = Vector(80, 80, 80)

-- Sounds --
ENT.OnDamageSounds = {}
ENT.OnDeathSounds = {"fallenlogic/nexu/nexu_screech.mp3"}
