...
SWEP.Primary.RPM					= 205
SWEP.Primary.RPM_Burst				= 205
...
SWEP.VMPos = Vector(1.96, -6.814, -01.55)
...
SWEP.IronSightsPos = Vector(-5.66, -6.5, 3.22)
...
SWEP.VElements = {
	["d"] = { type = "Model", model = "models/weapons/ll30.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.25, 0.5, -2.1), angle = Angle(0, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_scoutblaster_reference001", rel = "d", pos = Vector(0, -1.3, 5.625), angle = Angle(0, 90, 0), size = Vector(0.33, 0.33, 0.33), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["d"] = { type = "Model", model = "models/weapons/ll30.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.5, 1.75, 0.85), angle = Angle(180, 90, -5), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.ScopeReticule_Scale 			= {1.01,1.01}
