local OBJ = NCS_PERMAWEAPONS.RegisterCharacter("aden")
...
if SERVER then
    ...
    hook.Add("Tick", "NCS_PERMAWEAPONS_ADEN_LOAD", function()
        ...
        if Aden_DC and Aden_DC.Support and Aden_DC.Support.List then
            ...
            Aden_DC.Support.List["NCS_PERMAWEAPONS"] = {
