COMBO.id = "niman"
COMBO.PrintName = "Niman"
COMBO.Author = "Kong"
COMBO.Description = "Form VI, Niman, is often viewed as a synthesis of previous forms. It was the last form to gain widespread acceptance among the Jedi, and it emphasizes balance in the Force."
