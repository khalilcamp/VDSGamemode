...
SWEP.PrintName						= "Z-2"
SWEP.Type							= "Galactic Rotary Canon Blaster"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.VElements = {
	["z6"] = { type = "Model", model = "models/sw_battlefront/weapons/Z6_Rotary_Cannon_Skin.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(0.75, 0, 1), angle = Angle(0, -90, 0), size = Vector(1.2, 1.1, 1.2), color = Color(70, 60, 50, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}	

SWEP.WElements = {
	["z6"] = { type = "Model", model = "models/sw_battlefront/weapons/Z6_Rotary_Cannon_Skin.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1, 1), angle = Angle(-6, 0, 180), size = Vector(1, 1, 1), color = Color(70, 60, 50, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
