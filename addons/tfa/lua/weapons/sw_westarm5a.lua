...
SWEP.Primary.Sound 					= Sound ("everfall/weapons/eweb/cannons_eweb_laser_close_var_08.mp3");
...
SWEP.Attachments = {
[1] = {atts = {"training_mod","explosive_mod"},order = 1},
}
...
SWEP.VElements = {
	["m5"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm5_h.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(1.65, -8, .3), angle = Angle(0, -90, 0), size = Vector(.7, .7, .7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {1} },
   	["Ironsight"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/mando_westar35_scope2.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(.75, 3.5, 3.8), angle = Angle(0, -90, 0), size = Vector(.5, .5, .5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}	

SWEP.WElements = {
	["m5"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm5_h.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6, 2, 0), angle = Angle(190, 180, 0), size = Vector(.9, .9, .9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {1} },
}
