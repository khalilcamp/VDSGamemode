...
SWEP.VMPos = Vector(0.91, -7, -0.175)
...
SWEP.IronSightsPos = Vector(-4.9, -6, 2.02)
...
SWEP.VElements = {
	["k16"] = { type = "Model", model = "models/hauptmann/star wars/weapons/relby_k23.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.1, -5, -04.85), angle = Angle(0, 90, 0), size = Vector(1.05, 1.05, 1.05), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["k16"] = { type = "Model", model = "models/hauptmann/star wars/weapons/relby_k23.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.5, 1.85, 02.4), angle = Angle(-5, -02, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
