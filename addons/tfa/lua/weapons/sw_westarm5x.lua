...
SWEP.Primary.RPM_Semi				= false
SWEP.Primary.BurstDelay				= 0.35
SWEP.Primary.Sound 					= Sound ("everfall/weapons/se-44/blasters_se-44_laser_close_var_07.mp3");
...
SWEP.VElements = {
	["m5"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm5_s.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(1.65, -8, .3), angle = Angle(0, -90, 0), size = Vector(.7, .7, .7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(.75, -2.2, 4.85), angle = Angle(0, 90, 0), size = Vector(0.3, 0.3, 0.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
}	

SWEP.WElements = {
	["m5"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm5_h.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6, 2, 0), angle = Angle(190, 180, 0), size = Vector(.9, .9, .9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
