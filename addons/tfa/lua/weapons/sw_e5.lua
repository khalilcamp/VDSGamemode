...
SWEP.Primary.Sound 					= Sound ("everfall/weapons/e-5/b1/blasters_e5_laser_close_var_06.mp3");
...
SWEP.IronSightsPos = Vector(-4.1, -2, 1)
...
SWEP.VElements = {
	["e5"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/e5.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(0, -9, 1.5), angle = Angle(0, -90, 0), size = Vector(.8, .8, .8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["e5"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/e5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6.5, 2.5, 0), angle = Angle(-13, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
