...
SWEP.PrintName						= "NT-242c"
SWEP.Type							= "Galactic Heavy Advanced Sniper Blaster"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.KickUp					= 0.3*4
SWEP.Primary.KickDown				= 0.18*4
SWEP.Primary.KickHorizontal			= 0.055*4
