...
SWEP.PrintName						= "CB-1 Blaster Pistol"
SWEP.Type							= "Special Forces Blaster Pistol"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.IronSightsPos = Vector(-6, -6, 1.4)
...
SWEP.VElements = {
	["d"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/generic_gun2.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-1.25, 9, .75), angle = Angle(0, 90, 0), size = Vector(.7, .7, .7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["d"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/generic_gun2.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-5.75, 2, -1.1), angle = Angle(-05, 0, 180), size = Vector(.7, .7, .7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
