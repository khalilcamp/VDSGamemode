...
function ENT:SpawnRepulsors()
	...
	e:SetModel("models/svenman/ut-at_smol/repulsor.mdl")
...
function ENT:SpawnSeats()
	local e = ents.Create("prop_dynamic")
	e:SetModel("models/svenman/ut-at_smol/seats.mdl")
	e:SetPos(self:GetPos())
	e:SetAngles(self:GetAngles())
	e:SetParent(self)
	e:SetSolid(SOLID_VPHYSICS)
...
function ENT:SpawnDoors()
	local e = ents.Create("prop_dynamic")
	e:SetModel("models/svenman/ut-at_smol/doors.mdl")
	e:SetPos(self:GetPos())
	e:SetAngles(self:GetAngles())
	e:SetParent(self)
...
function ENT:SpawnInside()
	local e = ents.Create("prop_dynamic")
	e:SetModel("models/svenman/ut-at_smol/inside.mdl")
	e:SetPos(self:GetPos())
	e:SetAngles(self:GetAngles())
	e:SetParent(self)
	e:SetSolid(SOLID_NONE)
...
function ENT:SpawnBody()
	local e = ents.Create("prop_dynamic")
	e:SetModel("models/svenman/ut-at_smol/body.mdl")
	e:SetPos(self:GetPos())
	e:SetAngles(self:GetAngles())
	e:SetParent(self)
	e:SetSolid(SOLID_NONE)
...
function ENT:SpawnCable()
	local e = ents.Create("prop_dynamic")
	e:SetModel("models/svenman/ut-at_smol/cable.mdl")
	e:SetPos(self:GetPos())
	e:SetAngles(self:GetAngles())
	e:SetParent(self)
	e:SetSolid(SOLID_NONE)
...
function ENT:OnSpawn(PObj)
	...
	local DriverSeat = self:AddDriverSeat( Vector(470,0,160-15)*0.7, Angle(0,-90,0) )
	DriverSeat.HidePlayer = true
	DriverSeat.ExitPos = Vector(180,250,77.5)

	self:GetDriverSeat():SetCameraDistance( 1 )

	local TurretSeat = self:AddPassengerSeat( Vector(-20,0,90-15)*0.7, Angle(0,-90,0) )
	self:SetTurretSeat( TurretSeat )
	TurretSeat.ExitPos = Vector(180,250,77.5)
	
	local TurretL1Seat = self:AddPassengerSeat( Vector(-150.5,60,85-15)*0.7, Angle(0,0,0) )
	self:SetTurretL1Seat( TurretL1Seat )
	TurretL1Seat.ExitPos = Vector(180,250,77.5)
	
	local TurretL2Seat = self:AddPassengerSeat( Vector(-275,60,85-15)*0.7, Angle(0,0,0) )
	self:SetTurretL2Seat( TurretL2Seat )
	TurretL2Seat.ExitPos = Vector(180,250,77.5)
	
	local TurretR1Seat = self:AddPassengerSeat( Vector(-150.5,-60,85-15)*0.7, Angle(0,-180,0) )
	self:SetTurretR1Seat( TurretR1Seat )
	TurretR1Seat.ExitPos = Vector(180,-250,77.5)
	
	local TurretR2Seat = self:AddPassengerSeat( Vector(-275,-60,85-15)*0.7, Angle(0,-180,0) )
	self:SetTurretR2Seat( TurretR2Seat )
	TurretR2Seat.ExitPos = Vector(180,-250,77.5)
	
	local UnderturretSeat = self:AddPassengerSeat( Vector(353,0,182-15)*0.7, Angle(0,-90,0) )
	self:SetUnderturretSeat( UnderturretSeat )
	UnderturretSeat.ExitPos = Vector(180,-250,77.5)
	
	self:AddPassengerSeat( Vector(297,35,99)*0.7, Angle(0,90,0)).ExitPos = Vector(180,250,77.5)
	self:AddPassengerSeat( Vector(297,60.5,99)*0.7, Angle(0,90,0)).ExitPos = Vector(180,250,77.5)
	self:AddPassengerSeat( Vector(297,86,99)*0.7, Angle(0,90,0)).ExitPos = Vector(180,250,77.5)
	self:AddPassengerSeat( Vector(297,112,99)*0.7, Angle(0,90,0)).ExitPos = Vector(180,250,77.5)
	self:AddPassengerSeat( Vector(297,139,99)*0.7, Angle(0,90,0)).ExitPos = Vector(180,250,77.5)
	self:AddPassengerSeat( Vector(297,165,99)*0.7, Angle(0,90,0)).ExitPos = Vector(180,250,77.5)
	self:AddPassengerSeat( Vector(297,190.4,99)*0.7, Angle(0,90,0)).ExitPos = Vector(180,250,77.5)
	...
	self:AddPassengerSeat( Vector(188,-129,99)*0.7, Angle(0,0,0)).ExitPos = Vector(180,-250,77.5)
	self:AddPassengerSeat( Vector(161,-129,99)*0.7, Angle(0,0,0)).ExitPos = Vector(180,-250,77.5)
	self:AddPassengerSeat( Vector(139,-129,99)*0.7, Angle(0,0,0)).ExitPos = Vector(180,-250,77.5)

	self:AddPassengerSeat( Vector(188,129,99)*0.7, Angle(0,180,0)).ExitPos = Vector(180,250,77.5)
	self:AddPassengerSeat( Vector(161,129,99)*0.7, Angle(0,180,0)).ExitPos = Vector(180,250,77.5)
	self:AddPassengerSeat( Vector(139,129,99)*0.7, Angle(0,180,0)).ExitPos = Vector(180,250,77.5)
...
function ENT:InitWheels()
	...
	local WheelPos = {
		Vector(172.5, 230, -0)*0.7,
		Vector(97	 , 230, -0)*0.7,
		Vector(21.5 , 230, -0)*0.7,
		Vector(-54	 , 230, -0)*0.7,
		Vector(-129.5 , 230, -0)*0.7,
		Vector(-205   , 230, -0)*0.7,
		Vector(-280.5 , 230, -0)*0.7,
		Vector(-356   , 230, -0)*0.7,
