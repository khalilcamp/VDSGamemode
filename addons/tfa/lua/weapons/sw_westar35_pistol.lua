...
SWEP.PrintName						= "Westar-35 Pistol"
...
SWEP.IronInSound 					= nil --Sound ("w/sw_in.wav");
SWEP.IronOutSound 					= nil --Sound ("w/sw_out.wav");
...
SWEP.Primary.DefaultClip			= 22*5
SWEP.Primary.RPM					= 260*2
SWEP.Primary.RPM_Burst				= 260*2
...
SWEP.VMPos = Vector(0.91, -9, -0.175)
...
SWEP.IronSightsPos = Vector(-4.5, -4, 2.4)
...
SWEP.VElements = {
	["w35"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_pistol.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-1.8, 11, .5), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
   	["Ironsight"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/mando_westar35_scope2.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-.53, -2, 2.2), angle = Angle(0, 90, 0), size = Vector(.5, .5, .5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["w35"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-7.5, 1, .94), angle = Angle(-10, -10, 170), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
