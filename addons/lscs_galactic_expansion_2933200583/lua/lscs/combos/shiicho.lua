COMBO.id = "shiicho"
COMBO.PrintName = "Shii-Cho"
COMBO.Author = "Kong"
COMBO.Description = "As the most simplistic form, Shii-Cho was the first form taught to initiates within the Jedi Order. Form I training provided the basic knowledge of the sword-fighting principles and blast-deflection skill that was required for practice of all the other forms."
