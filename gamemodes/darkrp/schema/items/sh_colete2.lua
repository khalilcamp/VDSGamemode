...
ITEM.name = "Bateria Medium"
ITEM.description = "Uma bateria com mair capacidade de proteção mais resistente contra armas mais pesadas, ainda não totalmente forte, com a totalidade de +45 de AP."
ITEM.price = 90
