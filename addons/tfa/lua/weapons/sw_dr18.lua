...
SWEP.PrintName						= "DR-18"
SWEP.Type							= "Republic Blaster Revolver"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.Sound 					= Sound ("everfall/weapons/glie-44/blasters_glie44_laser_close_var_02.mp3");
...
SWEP.IronSightsPos = Vector(-5, -6, 2.5)
...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dr18.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-1.8, 10.6, .7), angle = Angle(0, 90, 0), size = Vector(.8, .8, .8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dr18.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-7, 2.5, 0), angle = Angle(-10, 0, 180), size = Vector(.8, .8, .8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
