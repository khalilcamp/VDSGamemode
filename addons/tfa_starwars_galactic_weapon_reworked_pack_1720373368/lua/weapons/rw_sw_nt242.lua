...
SWEP.Type							= "Galactic Heavy Sniper Blaster"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.VMPos = Vector(1.9185, 0, -01.534)
SWEP.VMAng = Vector(0,0,0)

SWEP.IronSightTime 					= 0.45
SWEP.Primary.KickUp					= 0.3*3
SWEP.Primary.KickDown				= 0.18*3
...
SWEP.IronSightsPos = Vector(-4.85, -7, 0.7)
...
SWEP.VElements = {
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0.699, 2.2, 6.96), angle = Angle(0, 90, 0), size = Vector(0.16, 0.16, 0.16), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
	["nt"] = { type = "Model", model = "models/sw_battlefront/weapons/nt242_longblaster.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0.7, 4, 0), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}	

SWEP.WElements = {
	["nt"] = { type = "Model", model = "models/sw_battlefront/weapons/nt242_longblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 0, -0.5), angle = Angle(-12, 0, 170), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
