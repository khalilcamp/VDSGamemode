...
SWEP.PrintName						= "E-5 Elite"
SWEP.Type							= "CIS Carbine Blaster"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.Sound 					= Sound ("everfall/weapons/e-5/b1/blasters_e5_laser_close_var_05.mp3");
...
SWEP.IronSightsPos = Vector(-4.25, -3, 1.4)
...
SWEP.VElements = {
	["e5"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/e5elite.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(0, -11, 0), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
   	["Ironsight"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/mando_westar35_scope2.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-1.2, 2.2, 4.97), angle = Angle(180, 90, 180), size = Vector(.7, .7, .7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["e5"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/e5elite.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6.5, 2.5, -.5), angle = Angle(-8, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
 }
