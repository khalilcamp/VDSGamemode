...
SWEP.PrintName						= "B-10"
SWEP.Type							= "Republic Heavy Blaster Pistol"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.Sound 					= Sound ("everfall/weapons/x8/fire/blasters_x8_laser_close_var_03.mp3");
...
SWEP.IronSightsPos = Vector(-5.75, -6, 1.5)
...
SWEP.VElements = {
	["d"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/b10.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-1.4, 8.9, .6), angle = Angle(0, 90, 0), size = Vector(.7, .7, .7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["d"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/b10.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6, 2.2, -1.1), angle = Angle(-05, 0, 180), size = Vector(.7, .7, .7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
