...
SWEP.IronSightsPos = Vector( -5.615, -8, 02.145)
...
SWEP.VElements = {
    ["ee3"] = { type = "Model", model = "models/sw_battlefront/weapons/ee3_carbine.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0, -0.5, -0.5), angle = Angle(0, -90, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
