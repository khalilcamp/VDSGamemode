...
SWEP.IronSightsPos = Vector(-2, -4, 2)
...
SWEP.VElements = {
	...
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(3.7, .7, 4.77), angle = Angle(0, 90, 0), size = Vector(.22, .22, .22), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
}
