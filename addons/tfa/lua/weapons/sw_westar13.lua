...
SWEP.Manufacturer 					= "Concordian Armory"
SWEP.Author							= "Kai"
SWEP.Contact						= ""
SWEP.Spawnable						= true
...
SWEP.PrintName						= "GALAAR-15 Scattershot Blaster"
SWEP.Type							= "Mandalorian Heavy Blaster Shotgun"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.DefaultClip			= 6*5
SWEP.Primary.RPM					= 110
SWEP.Primary.RPM_Burst				= 110
SWEP.Primary.Ammo					= "buckshot"
SWEP.Primary.AmmoConsumption 		= 1
SWEP.Primary.Range 					= 2500
SWEP.Primary.RangeFalloff 			= -1
SWEP.Primary.NumShots				= 6
SWEP.Primary.Automatic				= false
SWEP.Primary.RPM_Semi				= nil
SWEP.Primary.BurstDelay				= 0.2
SWEP.Primary.Sound 					= Sound ("everfall/weapons/miscellaneous/corebass/flanged/blasters_shared_corebass_close_flanged_var_03.mp3");
...
SWEP.VElements = {
	["sg"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_shotgun.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(1.8, -10.7, .75), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["sg"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_shotgun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-10.7, 1.8, 0.75), angle = Angle(-11, 0, 180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
