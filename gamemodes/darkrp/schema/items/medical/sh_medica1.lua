...
ITEM.name = "Bolsa Médica"
ITEM.description = "Uma bolsa cheia de medicamentos e remédios, pode ser usada para tratar ferimentos graves, com a totalidade de +75 de Vitalidade."
ITEM.price = 90
ITEM.category = "Medicina"

-- Item Configuration

ITEM.model = "models/starwars/items/medpack.mdl"
ITEM.skin = 0
...
ITEM.functions.Apply = {
    ...
    OnRun = function(itemTable)
        ...
        ply:SetAction("Aplicando "..itemTable.name.."...", 6, function()
        ...
        if ( IsValid(target) and target:IsPlayer() ) then
            if ( target:GetCharacter() ) then
                ...
                ply:SetAction("Aplicando "..itemTable.name.."...", 4, function()
                    ply:EmitSound("medkit_2.wav", itemTable.Volume)
