...
-- Misc --
ENT.PrintName = "[TFU] Bull Rancor"
ENT.Category = "[Valkyrie] Creature NPCs"
ENT.Models = {"models/tfu/bull_rancor.mdl"}
ENT.Skins = {0}
ENT.ModelScale = 2
ENT.CollisionBounds = Vector(140, 140, 140)
...
if SERVER then
  ...
  if math.random(1,2) == 1 then
	...
	util.ScreenShake( self:GetPos(), 10, 5, 5, 5000 )
  ...
  function ENT:OnChaseEnemy(enemy) 
	util.ScreenShake( self:GetPos(), 3, 5, 5, 5000 )
  end
