...
ITEM.name = "Med Create"
ITEM.description = "Um simples tubo de kolto, usado para fins medicinais também, embora que seja mais fraco ainda é útil, com a capacidade de +2000 de Vitalidade."
ITEM.price = 45
ITEM.category = "Medicina"

-- Item Configuration

ITEM.model = "models/cire992/props3/crate_med_01.mdl"
ITEM.skin = 0
...
ITEM.functions.Apply = {
    ...
    OnRun = function(itemTable)
        ...
        ply:SetAction("Aplicando "..itemTable.name.."...", 1, function()
        ...
        if ( IsValid(target) and target:IsPlayer() ) then
            if ( target:GetCharacter() ) then
                ...
                ply:SetAction("Aplicando "..itemTable.name.."...", 4, function()
                    ...
                    target:SetHealth(math.min(target:Health() + itemTable.HealAmount + ply:GetCharacter():GetAttribute("attribute_medical", 0), target:GetMaxHealth()))
