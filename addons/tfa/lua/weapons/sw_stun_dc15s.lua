...
SWEP.VElements = {
	["dc15s"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc15s.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-.1, -8, 0), angle = Angle(1, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
