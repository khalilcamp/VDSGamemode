...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/addoncontent/bactagrenade/bactagrenade.mdl", bone = "ValveBiped.Grenade_body", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 180, 0), size = Vector(0.69, 0.69, 0.69), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/addoncontent/bactagrenade/bactagrenade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.825, 2.743, 0), angle = Angle(0, -150.155, 0), size = Vector(0.82, 0.82, 0.82), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.PrintName				= "Granada de Bacta"
