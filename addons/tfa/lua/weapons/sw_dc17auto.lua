...
SWEP.PrintName						= "DC-17 Auto BlasTech Pistol"
...
SWEP.IronSightsPos = Vector(-5, -7, 3)
...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc17_heavy.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-1.8, 10, .5), angle = Angle(0, 90, 0), size = Vector(.8, .8, .8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc17_heavy.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-8, 2.7, -.9), angle = Angle(-5, 0, 180), size = Vector(.89, .89, .89), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
