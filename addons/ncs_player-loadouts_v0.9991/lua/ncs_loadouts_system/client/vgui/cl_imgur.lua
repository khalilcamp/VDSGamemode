...
function PANEL:Paint(w, h)
    ...
    if not self:IsEnabled() then
        NCS_LOADOUTS.DrawImgur(imageOffsetW, imageOffset, imageSize, imageSize, self:GetImgurID(), self:GetDisabledColor())
        return
    end
    ...
    NCS_LOADOUTS.DrawImgur(imageOffsetW, imageOffset, imageSize, imageSize, self:GetImgurID(), col)
end

vgui.Register("NCS_LOD_IMGUR", PANEL, "DButton")