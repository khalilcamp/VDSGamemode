...
SWEP.Type							= "Republic Commando Side Arm"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.DefaultClip			= 26*5
SWEP.Primary.RPM					= 355
SWEP.Primary.RPM_Burst				= 355*3
...
SWEP.Primary.Sound 					= Sound ("everfall/weapons/scout_trooper_pistol/fire/blasters_scouttrooperpistol_laser_close_var_11.mp3");
...
SWEP.WorldModel						= "models/bf2017/c_scoutblaster.mdl"
...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc17_commandopistol.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-1.8, 10.7, 1), angle = Angle(0, 90, 0), size = Vector(.8, .8, .8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc17_commandopistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-8.5, 2, -1.2), angle = Angle(-5, 0, 180), size = Vector(.89, .89, .89), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
