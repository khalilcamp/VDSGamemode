...
local PANEL = {
    ...
    AddPage = function(self, title, icon, cb)
        ...
        BUTTON:Dock(TOP)
        BUTTON:SetHeight(self.SCROLL:GetTall() * 0.05)
        BUTTON:SetFont("NCS_LOD_FRAME_TITLE")
        ...
        BUTTON.Paint = function(s, w, h)
            ...
            if icon then
                NCS_LOADOUTS.DrawImgur(w * 0.025, imageOffset, imageSize, imageSize, icon, COL)
            end
        end
...
vgui.Register( "NCS_LOD_SIDEBAR", PANEL )