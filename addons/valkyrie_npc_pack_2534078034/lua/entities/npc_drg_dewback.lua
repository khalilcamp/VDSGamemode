...
-- Misc --
ENT.PrintName = "Dewback"
ENT.Category = "[Valkyrie] Creature NPCs"
ENT.Models = {"models/swtor/npcs/dewback_dewback_a01_v01.mdl"}
ENT.Skins = {0}
ENT.ModelScale = 1
ENT.CollisionBounds = Vector(40, 72, 40)
...
-- Sounds --
ENT.OnSpawnSounds = {"fallenlogic/dewback/dewback_spawn.wav"}
ENT.OnIdleSounds = {}
...
if SERVER then
  ...
  function ENT:CustomInitialize() 
  	local mount_position = Vector(self:GetPos().x,self:GetPos().y,self:GetPos().z+50)
