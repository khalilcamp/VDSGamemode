...
function RDV.MEDALS.GetImgur(id, callback, useproxy, matSettings)
    ...
    http.Fetch(useproxy and "https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com" or "https://i.imgur.com/" .. id .. ".png",
        ...
        function(error)
            ...
            return RDV.MEDALS.GetImgur(id, callback, true)
        end
    )
end

function RDV.MEDALS.DrawImgur(x, y, w, h, imgurId, col)
    ...
    if not materials[imgurId] then
        ...
        RDV.MEDALS.GetImgur(imgurId, function(mat)
