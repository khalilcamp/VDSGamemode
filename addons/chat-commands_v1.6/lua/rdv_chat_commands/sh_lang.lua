...
function NCS_CHATCOMMANDS.AddLang(lang, note)
    RegisterLang(lang)
...
function NCS_CHATCOMMANDS.GetLang(lang, note, replacements)
    if !lang then
        lang = NCS_CHATCOMMANDS.CFG.lang or "en"
    end
...
function NCS_CHATCOMMANDS.GetLanguages()
    return LANG
end