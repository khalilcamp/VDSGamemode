...
-- Misc --
ENT.PrintName = "Tauntaun"
ENT.Category = "[Valkyrie] Creature NPCs"
ENT.Models = {"models/swtor/npcs/tauntaun_tauntaun_a01.mdl"}
ENT.Skins = {0}
ENT.ModelScale = 1
ENT.CollisionBounds = Vector(72, 72, 20)
...
-- Sounds --
ENT.OnSpawnSounds = {"fallenlogic/tauntaun/tauntaun_spawn.wav"}
ENT.OnIdleSounds = {}
...
if SERVER then
  ...
  function ENT:CustomInitialize() 
  	local mount_position = Vector(self:GetPos().x+9,self:GetPos().y,self:GetPos().z+42)
