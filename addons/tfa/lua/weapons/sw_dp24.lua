...
SWEP.Type							= "Republic Submachine Blaster"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.Sound 					= Sound ("everfall/weapons/dc-15s/blasters_dc15_laser_close_var_02.mp3");
...
SWEP.IronSightsPos = Vector(-5, -4, 5)
...
SWEP.VElements = {
	["dc15s"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dp24.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(0, -8, 0), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
   	["Ironsight"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/mando_westar35_scope2.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-1.14, 4, 2.7), angle = Angle(0, -90, 0), size = Vector(.8, .8, .8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["dc15s"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dp24.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6, 2.2, 0), angle = Angle(-13, 0, 180), size = Vector(.9, .9, .9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
