...
SWEP.PrintName				= "Flamethrower M2"		-- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_doi/v_flame_m2.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_doi/w_flame_m2.mdl" -- Weapon world model path
SWEP.Bodygroups_W = nil --{
--[0] = 1,
--[1] = 4,
--[2] = etc.
--}
SWEP.DefaultHoldType = "smg" -- This is how others view you carrying the weapon. Options include:
