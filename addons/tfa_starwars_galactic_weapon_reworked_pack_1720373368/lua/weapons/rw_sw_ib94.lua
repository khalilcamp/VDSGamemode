...
SWEP.IronSightsPos = Vector(-5.8175, -7, 3.2)
...
SWEP.VElements = {
	["d"] = { type = "Model", model = "models/cs574/weapons/dc92.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.25, -4, -0.38), angle = Angle(0, 90, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["d"] = { type = "Model", model = "models/cs574/weapons/dc92.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.5, 02, -1), angle = Angle(-5, -7, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
