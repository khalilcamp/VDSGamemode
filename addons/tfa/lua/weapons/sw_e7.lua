...
SWEP.PrintName						= "E-7"
SWEP.Type							= "Republic Experimental Blaster"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.Sound 					= Sound ("everfall/weapons/e-11/style_1/blasters_e11_laser_close_var_04.mp3");
...
SWEP.IronSightsPos = Vector(-4.92, -8, 3.5)
...
SWEP.VElements = {
	["e11"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/e7.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-.2, -6, .5), angle = Angle(0, -90, 0), size = Vector(.8, .8, .8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-1.1, 1.7, 3.98), angle = Angle(0, 90, 0), size = Vector(0.3, 0.3, 0.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },	
}

SWEP.WElements = {
	["e11"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/e7.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-7, 1.7, 0), angle = Angle(192, 180, 0), size = Vector(.9, .9, .9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
