...
function PANEL:Paint(w, h)
    ...
    if not self:IsEnabled() then
        NCS_TRANSPORT.DrawImgur(imageOffsetW, imageOffset, imageSize, imageSize, self:GetImgurID(), self:GetDisabledColor())
        return
    end
    ...
    NCS_TRANSPORT.DrawImgur(imageOffsetW, imageOffset, imageSize, imageSize, self:GetImgurID(), col)
end

vgui.Register("NCS_TRANSPORT_IMGUR", PANEL, "DButton")