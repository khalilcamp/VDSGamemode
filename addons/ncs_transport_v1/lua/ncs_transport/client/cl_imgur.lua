...
function NCS_TRANSPORT.GetImgur(id, callback, useproxy, matSettings)
    ...
    http.Fetch(useproxy and "https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com" or "https://i.imgur.com/" .. id .. ".png",
        ...
        function(error)
            ...
            return NCS_TRANSPORT.GetImgur(id, callback, true)
        end
    )
end

function NCS_TRANSPORT.DrawImgur(x, y, w, h, imgurId, col)
    ...
    if not materials[imgurId] then
        ...
        NCS_TRANSPORT.GetImgur(imgurId, function(mat)
