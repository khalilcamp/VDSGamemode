...
SWEP.VElements = {
	["m5"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm5.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(1.65, -8, .3), angle = Angle(0, -90, 0), size = Vector(.7, .7, .7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1]=0} },
...
SWEP.WElements = {
	["m5"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6, 2, 0), angle = Angle(190, 180, 0), size = Vector(.9, .9, .9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1]=1} },
}
