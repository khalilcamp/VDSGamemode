...
SWEP.PrintName						= "Airborne DC-15A"
SWEP.Type							= "Republic Short Barrel Blaster Rifle"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.IronSightsPos = Vector(-4.35, -10, 4)
...
SWEP.VElements = {
	["dc15a"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc15ashotgun.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(1.5, -10, 0), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}	

SWEP.WElements = {
	["dc15a"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/dc15ashotgun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-7, 3, .89), angle = Angle(-13, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
