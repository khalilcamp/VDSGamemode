...
ITEM.name = "Soda Brilhante"
ITEM.model = Model("models/props_junk/popcan01a.mdl")
ITEM.description = "Uma latinha de soda, mas é de uma edição especial, produzida nas grandes fabricas do núcleo da galáxia, é apenas uma comida para consumo."
