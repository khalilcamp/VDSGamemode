...
SWEP.Type							= "Mandalorian Blaster Carbine"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.IronSightsPos = Vector( -4.825, -3, 3.3)
...
SWEP.VElements = {
    ["w11"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_carbine.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(.5, -11, 1), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
    ["w11"] = { type = "Model", model = "models/jajoff/sps/cgiweapons/tc13j/westarm35_carbine.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-8, 1.7, 0), angle = Angle(-11.5, 0, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
